...
numero_da_pagina = 0
while True:
    url = "https://portal.cehr.ft.lisboa.ucp.pt/BeliefAndCitizenship/BDImprensa/DisplayAdvancedSearchResults.php?viewPage=" + str(numero_da_pagina) + "&ordenationCriteria=name"
